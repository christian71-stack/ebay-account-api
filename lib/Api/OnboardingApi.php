...
class OnboardingApi
{
     ...
     * @return \Ebay\Sell\Account\Model\PaymentsProgramOnboardingResponse
     */
     ...
     * @throws \Ebay\Sell\Account\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ebay\Sell\Account\Model\PaymentsProgramOnboardingResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPaymentsProgramOnboardingWithHttpInfo($marketplace_id, $payments_program_type)
    {
        $returnType = '\Ebay\Sell\Account\Model\PaymentsProgramOnboardingResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ebay\Sell\Account\Model\PaymentsProgramOnboardingResponse',
