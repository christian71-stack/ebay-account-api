...
class PrivilegeApi
{
     ...
     * @return \Ebay\Sell\Account\Model\SellingPrivileges
     */
     ...
     * @throws \Ebay\Sell\Account\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ebay\Sell\Account\Model\SellingPrivileges, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPrivilegesWithHttpInfo()
    {
        $returnType = '\Ebay\Sell\Account\Model\SellingPrivileges';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ebay\Sell\Account\Model\SellingPrivileges',
