...
class ReturnPolicyRequest implements ModelInterface, ArrayAccess
{
     ...
     * Sets category_types
     *
     * @param \Ebay\Sell\Account\Model\CategoryType[] $category_types This container indicates which category group that the return policy applies to.<br><br><span class=\"tablenote\"><b>Note</b>: Return business policies are not applicable to motor vehicle listings, so the <b>categoryTypes.name</b> value must be set to <code>ALL_EXCLUDING_MOTORS_VEHICLES</code> for return business policies.</span>
     *
     * @return $this
     */
     ...
     * Sets refund_method
     *
     * @param string $refund_method This value indicates the refund method that will be used by the seller for buyer returns.<p class=\"tablenote\"><span  style=\"color: #dd1e31;\"><b>Important!</b></span> If this field is not included in a return business policy, it will default to MONEY_BACK.</p> For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/account/types/api:RefundMethodEnum'>eBay API documentation</a>
     *
     * @return $this
     */
     ...
     * Sets return_method
     *
     * @param string $return_method This field can be used if the seller is willing and able to offer a replacement item as an alternative to 'Money Back'. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/account/types/api:ReturnMethodEnum'>eBay API documentation</a>
     *
     * @return $this
     */
