...
class SetPaymentPolicyResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'deposit' => '\Ebay\Sell\Account\Model\Deposit',
        'description' => 'string',
        'full_payment_due_in' => '\Ebay\Sell\Account\Model\TimeDuration',
        'immediate_pay' => 'bool',
     ...
     * Sets category_types
     *
     * @param \Ebay\Sell\Account\Model\CategoryType[] $category_types This container indicates whether the payment business policy applies to motor vehicle listings, or if it applies to non-motor vehicle listings.
     *
     * @return $this
     */
     ...
     * Gets deposit
     *
     * @return \Ebay\Sell\Account\Model\Deposit
     */
     ...
     * Sets deposit
     *
     * @param \Ebay\Sell\Account\Model\Deposit $deposit deposit
     *
     * @return $this
     */
     ...
     *
     * @param \Ebay\Sell\Account\Model\TimeDuration $full_payment_due_in full_payment_due_in
     *
     * @return $this
     */
     ...
     *
     * @return \Ebay\Sell\Account\Model\PaymentMethod[]
     */
     ...
     *
     * @param \Ebay\Sell\Account\Model\PaymentMethod[] $payment_methods This array shows the available payment methods that the seller has set for the payment business policy.<br><br>Sellers do not have to specify any electronic payment methods for listings, so this array will often be returned empty unless the payment business policy is intended for motor vehicle listings or other items in categories where offline payments are required or supported.
     *
     * @return $this
     */
