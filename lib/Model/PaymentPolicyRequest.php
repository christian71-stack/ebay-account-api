...
class PaymentPolicyRequest implements ModelInterface, ArrayAccess
{
     ...
     * Sets category_types
     *
     * @param \Ebay\Sell\Account\Model\CategoryType[] $category_types This container is used to specify whether the payment business policy applies to motor vehicle listings, or if it applies to non-motor vehicle listings.
     *
     * @return $this
     */
