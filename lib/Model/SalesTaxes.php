...
class SalesTaxes implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'sales_taxes' => '\Ebay\Sell\Account\Model\SalesTax[]'
    ];
