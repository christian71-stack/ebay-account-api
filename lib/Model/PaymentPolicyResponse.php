...
class PaymentPolicyResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'next' => 'string',
        'offset' => 'int',
        'payment_policies' => '\Ebay\Sell\Account\Model\PaymentPolicy[]',
        'prev' => 'string',
        'total' => 'int'
    ];
     ...
     *
     * @param \Ebay\Sell\Account\Model\PaymentPolicy[] $payment_policies A list of all of the seller's payment business policies defined for the specified marketplace. This array will be returned as empty if no payment business policies are defined for the specified marketplace.
     *
     * @return $this
     */
