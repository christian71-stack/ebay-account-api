...
class ReturnPolicyResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'offset' => 'int',
        'prev' => 'string',
        'return_policies' => '\Ebay\Sell\Account\Model\ReturnPolicy[]',
        'total' => 'int'
    ];
     ...
     *
     * @param \Ebay\Sell\Account\Model\ReturnPolicy[] $return_policies A list of all of the seller's return business policies defined for the specified marketplace. This array will be returned as empty if no return business policies are defined for the specified marketplace.
     *
     * @return $this
     */
